...
import { updateProfileDataActionThunk } from "../ReduxStore/profileData/profileData.actions.async";
...
const UpdateUserProfile = (porps) => {
  ...
  const profileDataSchema = Yup.object().shape({
    ...
    phone: Yup.string().min(14, "Phone number is not valid").required("Phone number is required."),
                            ...
                            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                              <div className="form-group mb-3 position-relative password-field">
                                ...
                                <input
                                  ...
                                  onChange={(e) => formik.setValues({ ...formik.values, dateOfBirth: moment(e.target.value).format() })}
                                  onBlur={formik.handleBlur}
                                />
                              </div>
                            </div>
